...
class DefaultBandPrivileges implements DomainEntity {
    ...
    static DefaultBandPrivileges newBaseDefaultPrivileges(final EntityId entityId) {
        return DefaultBandPrivileges.builder()
                ...
                .canAddCalendarEntries(CanAddCalendarEntriesPrivilege.from(true))
                .canEditCalendarEntries(CanEditCalendarEntriesPrivilege.from(true))
                .canDeleteCalendarEntries(CanDeleteCalendarEntriesPrivilege.from(true))
                .canAccessFinanceHistory(CanAccessFinanceHistoryPrivilege.from(true))
                .canAddFinanceEntries(CanAddFinanceEntriesPrivilege.from(true))
